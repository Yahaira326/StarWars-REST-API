...
Revision ID: 2af7b88a187c
Revises: a74fb9990697
Create Date: 2023-01-26 18:38:36.932114
...
revision = '2af7b88a187c'
down_revision = 'a74fb9990697'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('vehicleClass', sa.String(length=250), nullable=False),
    ...
    sa.Column('maxAtmSpeed', sa.String(length=250), nullable=False),
    sa.Column('costinCredits', sa.String(length=250), nullable=False),
    sa.Column('cargoCapacity', sa.String(length=250), nullable=False),
